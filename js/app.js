		...
		MicroModal.init({
			...
			onShow: (modal, trigger, event) => {
				...
				if (trigger.hasAttribute('data-micromodal-iframe')) {
					...
					// ------- END простой способ добавления ютуб-видео по по айдишнику
					...
					var patterns = [
						...
						embedSrc = trigger.getAttribute('data-micromodal-iframe');
					...
					// ------- END подобно magnific-popup - добавления видео с любого хостинга, а также google-map

					console.log(embedSrc);
					// добавление айфрейма во всплывашку
