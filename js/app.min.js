...
module.exports.isMobile = isMobile; // сделали константу 5 доступной из других модулей
...
(function () {
  function MultilevelPanel(opts) {
    ...
    this.init = function () {
      ...
      menuLinks.forEach(function (item) {
        item.addEventListener('click', _this.linksClick);
      });
      ...
      htmlDoc.classList.remove('multilevel-panel-opened', 'freeze', 'catalog-visible', 'lock');
      _self.reset();
    }, this.open = function () {
      ...
      backTexts = [];
      Array.prototype.slice.call(document.querySelectorAll('.multilevel-menu ul.active')).forEach(function (menu) {
  ...
  var panel = new MultilevelPanel({
    backAsCurrent: true,
    //boolean |указание заголовка текущей ссылки вместо "назад"
    activeBreakpoint: 1100,
    //number | ширина экрана, при которой перестают раскрываться вложенные меню в левой панели
    ...
    // boolean ,
    multicolumn: false,
    //true только в случае различия хтмл в десктопном и мобильном меню (например, при наличии доп. дивов-колонок, в которые завернуты эл-ты. десктопного меню)
    multicolumnClass: 'catalog-header__column',
    // класс для дива-обертки над эл-ми. десктопного меню
...
(function () {
  ...
  if (document.querySelectorAll('.accordion') !== null) {
    Array.prototype.slice.call(document.querySelectorAll('.accordion')).forEach(function (item) {
...
(function () {
  ...
  var Combine = function Combine(combine) {
    ...
    this.accordion = function (checkPoint) {
      ...
      init = function init() {
      ...
      }, slideSiblings = function slideSiblings(item) {
        var parent = item.parentNode;
        var accordionChildren = item.closest('.accordion__item').parentNode.children;
        for (var i = 0; i < accordionChildren.length; i++) {
          if (accordionChildren[i] !== parent && accordionChildren[i].querySelector('.accordion__content') !== null) {
      ...
      }, slideUp = function slideUp(target, duration) {
        target.style.transitionProperty = 'height, margin, padding';
        target.style.transitionDuration = duration + 'ms';
        target.style.boxSizing = 'border-box';
        target.style.height = target.offsetHeight + 'px';
        ...
        target.parentNode.classList.remove('active');
      }, slideDown = function slideDown(target, duration) {
        target.classList.remove('hidden');
        var isHidden = target.classList.contains('hidden');
        if (isHidden) target.classList.remove('hidden');
        ;
        ...
        target.parentNode.classList.add('active');
      }, slideToggle = function slideToggle(target, duration) {
        if (target.classList.contains('hidden')) {
  ...
  if (document.querySelector('.combine') !== null) {
    Array.prototype.slice.call(document.querySelectorAll('.combine')).forEach(function (elem) {
...
function setFstDropdown() {
  var e = document.querySelectorAll(".fstdropdown-select:not(.fstcreated)");
  for (var t in e) {
    e.hasOwnProperty(t) && s(e[t]);
  }
  function s(e) {
    var t = e.dataset.searchdisable,
      s = e.dataset.placeholder,
      a = e.dataset.opened,
      r = d("div", "fstdiv", e.parentNode, null),
      i = d("div", "fstdropdown" + (null != a && "true" == a ? " open" : ""), r, null == a || "true" != a ? {
        click: l,
        blur: l
      } : null);
    if (i.select = e, i.setAttribute("tabindex", "0"), null != a && "true" == a || d("div", "fstselected", i, null), null == t || "true" != t) {
      var u = d("div", "fstsearch", i, null),
        p = {
          keyup: o,
          paste: o
        };
      null != a && "true" == a || (p.blur = l), d("input", "fstsearchinput", u, p).placeholder = null != s ? s : "";
    }
    if (e.multiple) {
      var f = d("button", "fstAll", i, {
        click: c
      });
      f.textContent = "Select All", f.type = "button", f.selected = !1;
    }
    d("div", "fstlist", i, null), e.fstdropdown = {
      dd: i,
  ...
  function l(e, t, s) {
    var l = e.target.classList.contains("fstdropdown") ? e.target.select : e.target.closest(".fstdropdown").select;
    t = null == t ? "blur" != e.type : t;
    var a = l.fstdropdown.dd;
    if (!function (e, t) {
      ...
      if (!t || a.classList.contains("open")) return a.classList.remove("open"), void a.parentNode.classList.remove("open");
      a.classList.add("open"), a.parentNode.classList.add("open"), null == l.dataset.searchdisable && "true" != l.dataset.searchdisable && a.querySelector(".fstsearchinput").focus();
    }
  }
  function a(e) {
    var t = e.target.closest(".fstdropdown").select,
      s = t.fstdropdown.dd,
      a = s.querySelector(".fstAll"),
      n = null == t.dataset.opened || "true" != t.dataset.opened;
    t.value == e.target.dataset.value || t.multiple || (t.value = e.target.dataset.value, null != s.querySelector(".fstlist>.selected") && s.querySelector(".fstlist>.selected").classList.remove("selected"), e.target.classList.add("selected"), n && (s.querySelector(".fstselected").textContent = e.target.textContent), r("change", t)), t.multiple && function (e, t, s, l, a) {
      e.querySelector("[value='" + t.target.dataset.value + "']").selected = !t.target.classList.contains("selected"), t.target.classList.contains("selected") ? t.target.classList.remove("selected") : t.target.classList.add("selected");
      r("change", e);
      var n = s.querySelectorAll(".fstlist>.selected").length;
      l.selected = n > 0, a && (s.querySelector(".fstselected").textContent = 1 == n ? t.target.textContent : n + " options selected");
      l.textContent = l.selected ? "Deselect All" : "Select All";
    }(t, e, s, a, n), n && l(e, !1);
  }
  function n(e) {
    for (var t = e.querySelectorAll("option"), s = e.fstdropdown.dd.querySelector(".fstlist"); s.lastChild;) {
      s.removeChild(s.lastChild);
    }
    for (var l in t) {
      if (t.hasOwnProperty(l)) {
        var n = document.createElement("div");
        n.textContent = t[l].text, n.dataset.value = t[l].value, t[l].selected && n.classList.add("selected"), n.addEventListener("click", a), s.appendChild(n);
      }
    }
    i(e, null);
  }
  ...
  function o(e) {
    var t = "paste" != e.type ? "" : void 0 === e.clipboardData ? window.clipboardData.getData("Text") : e.clipboardData.getData("text/plain"),
      s = "paste" != e.type ? e.target.value : t,
      l = e.target.closest(".fstdropdown").querySelectorAll(".fstlist>div");
    for (var a in l) {
      l.hasOwnProperty(a) && (-1 != l[a].textContent.trim().toLowerCase().indexOf(s.trim().toLowerCase()) ? l[a].classList.remove("hideFst") : l[a].classList.add("hideFst"));
    }
  }
  function d(e, t, s, l) {
    var a = document.createElement(e);
    if (null != t) for (var n in t.split(" ")) {
      if (!isNaN(n)) a.classList.add(t.split(" ")[n]);
    }
    if (null != l) for (var r in l) {
      l.hasOwnProperty(r) && a.addEventListener(r, l[r], !0);
    }
  ...
  function c(e) {
    var t = e.target.closest(".fstdropdown").select,
      ...
      l = !e.target.selected;
    e.target.selected = l;
    var a = l ? s.querySelectorAll(".fstlist>div:not(.hideFst)") : s.querySelectorAll(".selected");
    for (var n in a) {
      a.hasOwnProperty(n) && (t.querySelector("[value='" + a[n].dataset.value + "']").selected = l, l ? a[n].classList.add("selected") : a[n].classList.remove("selected"));
    }
    r("change", t), e.target.textContent = l ? "Deselect All" : "Select All", i(t, e);
  }
  function i(e, t) {
    if (null == e.dataset.opened || "true" != e.dataset.opened) {
      var s = "",
        a = e.options[e.selectedIndex];
      if (e.multiple) {
        var n = 0;
        for (var r in e.options) {
          e.options.hasOwnProperty(r) && 1 == e.options[r].selected && n++;
        }
        s = 1 == n ? a.text : n + " options selected";
      }
      e.fstdropdown.dd.querySelector(".fstselected").textContent = e.multiple ? s : null != a ? a.text : "", null != t && l(t, !1, !0);
    }
  }
}
!function (e) {
...
(function quantityCounter() {
  ...
  this.click = function () {
    ...
    _self.render(_self.counter(buttonType, {
      min: minValue,
      max: maxValue,
      start: startValue
    }), countInp);
...
function Locations() {
  ...
  this.events = function () {
    ...
    _this.availableCheck();
  }, this.availableCheck = function () {
    if (citiesArrays[countriesSelect.value] == null) {
      _this.getCities(countriesSelect.value);
    }
  }, this.render = function (cities) {
    _toConsumableArray(cities).forEach(function (item, i) {
...
function dom7_esm_css(props, value) {
  var window = getWindow();
  var i;
...
function dom7_esm_next(selector) {
  if (this.length > 0) {
    if (selector) {
...
var dom7_esm_resize = shortcut('resize');
...
function closestElement(selector, base) {
  ...
  function __closestFrom(el) {
    if (!el || el === ssr_window_esm_getDocument() || el === getWindow()) return null;
...
// EXTERNAL MODULE: ./node_modules/formhandler.js/dist/js/formhandler.min.js
var formhandler_min = __webpack_require__(2);
var formhandler_min_default = /*#__PURE__*/__webpack_require__.n(formhandler_min);
...
core_class.use([navigation, pagination, autoplay, effect_fade, thumbs]);
...
//- All in one file--------------------------
var srvFuncs = __webpack_require__(14);
...
//- micromodal--------------------------
var MicroModal = __webpack_require__(19);
...
//- wNumb--------------------------
var wNumb = __webpack_require__(20);

// - noUiSlider--------------------------
var noUiSlider = __webpack_require__(21);
...
var Locations = __webpack_require__(27);
//- end VANILLA JS===================================
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.querySelector('.modal') !== null) {
    MicroModal.init({
      ...
      disableScroll: true,
      onShow: function onShow(modal, trigger, event) {
        // console.log(trigger)
        // console.log(event)
        // console.log(modal)
        ...
        if (trigger.hasAttribute('data-micromodal-iframe')) {
          ...
          modal.querySelector('.modal__content').insertAdjacentHTML('beforeend', '<div class="modal__video">' + '<iframe src=' + embedSrc + ' title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>' + '</div>');
        }
    ...
    if (screen.width >= 991) {
      if (target.classList.contains('catalog-menu__item') || target.parentElement.classList.contains('catalog-menu__item')) {
        if (target.parentElement.classList.contains('with-submenu')) {
          ...
          srvFuncs.siblings(target.parentElement).forEach(function (item) {
            return item.classList.remove('catalog-item-opened');
          });
          // classList.toggle('catalog-item-opened');
        }
      } else {
        document.querySelector('.catalog').classList.remove('catalog-opened');
        document.querySelectorAll('.catalog-menu__item').forEach(function (item) {
          return item.classList.remove('catalog-item-opened');
        });
      }
    }
  ...
  if (document.querySelector('.main__slider') !== null) {
    var mainSwiper = new core_class('.main__slider', {
      autoplay: {
        delay: 5000,
      ...
      on: {
        init: function init(swiper) {
          document.querySelector('.swiper-pages__overal').innerText = "/".concat(swiper.wrapperEl.querySelectorAll('.swiper-slide:not(.swiper-slide-duplicate)').length);
        },
        slideChange: function slideChange(swiper) {
          console.log(swiper.activeIndex);
          document.querySelector('.swiper-pages__current').innerText = swiper.realIndex < 10 ? "0".concat(swiper.realIndex + 1) : swiper.realIndex + 1;
        }
      }
    });
  ...
  if (document.querySelector('.banners-slider') !== null) {
    var bannerSwiper = new core_class('.banners-slider', {
  ...
  if (document.querySelector('.products-carousel') !== null) {
    new core_class('.products-carousel', {
      observer: true,
      observeParents: true,
      slidesPerView: 1.05,
      //spaceBetween: 0,
  ...
  if (document.querySelector('.novelties-swiper') !== null) {
    new core_class('.novelties-swiper', {
      observer: true,
      observeParents: true,
      slidesPerView: 1.15,
      //spaceBetween: 0,
  ...
  if (document.querySelector('.product-view__screen') !== null && document.querySelector('.product-view__nav') !== null) {
    var navSwiper = new core_class('.product-view__nav', {
      observer: true,
      observeParents: true,
      slidesPerView: 4,
      spaceBetween: 15,
    ...
    var screenSwiper = new core_class('.product-view__screen', {
      // effect: 'fade',
  ...
  tippy_esm('#product-tippy', {
    ...
    content: function content(reference) {
      return "<div class=\"points-tooltip\">".concat(reference.getAttribute('tooltip-title'), "</div>");
    },
    offset: [150, 15]
  });
  if (document.querySelector('.footer__form') != null) {
    new formhandler_min_default.a({
      form: {
        block: '.form-footer',
