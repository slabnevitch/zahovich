...
(function () {
  function Accordion(accordionList, duration
  /*, disableCheckPoint*/
  ) {
    var _self = this,
        links; // checkpoint = disableCheckPoint !== undefined ? disableCheckPoint : null;
...
var formhandler_min = __webpack_require__(0);
...
core_class.use([navigation, pagination, autoplay, effect_fade]);
 //- SERVIVE FUNCTIONS==================
//- remove-class--------------------------
...
__webpack_require__(3); //- isMobile--------------------------
// var isMobile = require('./vendor/libs-vanilla/service-functions/mobileDetect.js')
//- All in one file--------------------------


var srvFuncs = __webpack_require__(4); // Using: srvFuncs.siblings(), srvFuncs.removeClass(), etc
//- WITH JQUERY===================================
//- jquery--------------------------
...
var MicroModal = __webpack_require__(8); //- swiper--------------------------
...
var wNumb = __webpack_require__(9); // - noUiSlider--------------------------


var noUiSlider = __webpack_require__(10); //- iMask--------------------------
...
__webpack_require__(11); //- baguetteBox-------------------------- use: https://github.com/feimosi/baguetteBox.js#usage
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.querySelector('.range-slider') !== null) {
    ...
    Array.prototype.slice.call(document.querySelectorAll('.range')).forEach(function (rangeBlock) {
      ...
      inputMax.addEventListener('change', function () {
        slider.noUiSlider.set([null, +inputMax.value]); // this.style.width = ((this.value.length + 1) * widthKeff) + 'px';
      });
      inputMin.addEventListener('change', function () {
        console.log('min change!');
        slider.noUiSlider.set([+inputMin.value, null]); // this.style.width = ((this.value.length + 1) * widthKeff) + 'px';
      });
  ...
  document.onclick = function (e) {
    var target = e.target; // desktop catalog toggle
  ...
  if (document.querySelector('.footer__form') != null) {
    var pizdyk = new formhandler_min_default.a({
      form: {
        block: '.form-footer',
  ...
  if (document.querySelector('.modal') != null) {
    var piska = new formhandler_min_default.a({
      form: {
        block: '.callback-form',
