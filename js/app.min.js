...
core_class.use([navigation, pagination, autoplay, effect_fade]); // import FormHandler from 'formhandler.js';
//- SERVIVE FUNCTIONS==================
//- remove-class--------------------------
...
__webpack_require__(2); //- WITH JQUERY===================================
//- jquery--------------------------
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.querySelector('.products-carousel') !== null) {
    var productsSwiper = new core_class('.products-carousel', {
      observer: true,
      observeParents: true,
      slidesPerView: 1.05,
      //spaceBetween: 0,
  ...
  if (document.querySelector('.novelties-swiper') !== null) {
    var _productsSwiper = new core_class('.novelties-swiper', {
      observer: true,
      observeParents: true,
      slidesPerView: 1.15,
      //spaceBetween: 0,
