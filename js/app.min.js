...
//- All in one file--------------------------
var srvFuncs = __webpack_require__(3);
...
//- wNumb--------------------------
var wNumb = __webpack_require__(7);

// - noUiSlider--------------------------
var noUiSlider = __webpack_require__(8);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelector('.footer__form').onsubmit = function () {
    return console.log('submiy!');
  };
  if (document.querySelector('.formhandler') != null) {
    var formhandler = new formhandler_min_default.a({
      fields: {
        email: {
          validation: 'isEmail',
          notice: {
