    ...
    MicroModal.init({
      ...
      onShow: function onShow(modal, trigger, event) {
        ...
        if (trigger.hasAttribute('data-micromodal-iframe')) {
          var markup = '<div class="modal__video">' + '<iframe src=' + trigger.getAttribute('data-micromodal-iframe') + ' frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>' + '</div>',
            division = document.createElement('div');
          console.log(division);
          modal.querySelector('.modal__content').insertAdjacentHTML('beforeend', '<div class="modal__video">' + '<iframe src=' + trigger.getAttribute('data-micromodal-iframe') + ' title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>' + '</div>');
        }
